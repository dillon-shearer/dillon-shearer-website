            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  <div className="font-medium text-white text-sm sm:text-base mb-1">{item.text}</div>
                  {hasAnswered && !isCorrect && (
                    <div className="text-xs sm:text-sm text-white/70 mt-2 pt-2 border-t border-white/10">
                      Correct category:{' '}
