          ...
          return (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                {/* Left Item */}
                <div className="flex-1 font-medium text-white text-sm sm:text-base">{leftItem.text}</div>

                {/* Arrow - hidden on mobile */}
                <svg className="hidden sm:block w-6 h-6 text-white/40 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {hasAnswered && !isCorrect && (
                <div className="mt-2 pt-2 border-t border-white/10 text-xs sm:text-sm text-white/70">
                  Correct match:{' '}
